...
const AddFriendButton: FC<AddFriendButtonProps> = ({}) => {
    ...
    const { register , handleSubmit  ,setError ,formState:{errors}} = useForm<FormData>({
        resolver:zodResolver(addFriendValidator),  // Resolve form inputs against the schema
    })
  ...
  return <form onSubmit={handleSubmit(onSubmit)} className='max-w-sm'>
    <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900">Add Friend Email address</label>
